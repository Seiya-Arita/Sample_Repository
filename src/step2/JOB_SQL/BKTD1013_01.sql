...
# ==============================================================================
# 作成テーブル名称  :通知預入明細断面展開                      | HN_INFO.T_KT10130D_OBJ
# フェーズ          :共通処理
# サイクル          :日次
# 参照テーブル      :預金ＣＩＦ基本S                           | HN_V_SRC.T_YK51330D_SRC001
...
/* 通知預入明細断面展開 */
/* ****************************************************************** */
INSERT INTO ${INFO_DB}.[T_KT10130D_OBJ]
SELECT
    B.[基準日]
   ,A.[TBN]
   ,A.[CFB]
...
FROM
  (SELECT
     ...
     ,[SSSHYJ]
     ,[YNUKGK]
   FROM ${DB_T_SRC}.[T_YK51330D_SRC001] WHERE [Record_Deleted_Flag] = 0
