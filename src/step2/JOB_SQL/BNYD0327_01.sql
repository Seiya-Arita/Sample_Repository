...
# ==============================================================================
# 作成テーブル名称  :預かり資産残高＿債券                      | HN_INFO.T_NY03002D_WK8
# フェーズ          :預かり資産残高
# サイクル          :日次
...
/* BRKA債券明細S */
/* ****************************************************************** */
INSERT INTO ${INFO_DB}.[T_NY03002D_WK8]
SELECT
   B.[前日]                                                 AS [作成基準日],
   A.[TBN]                                                  AS [店番],
   A.[CFB]                                                  AS [ＣＩＦ番号],
   TRIM(CAST(dbo.FORMAT2(A.[SIKTCN],'ZZZ9') AS CHAR(4)))    AS [科目],
   TRIM(CAST(dbo.FORMAT2(A.[MSB],'ZZZZZZZZZZ9') AS CHAR(11))) AS [口座番号],
   A.[GKM]                                                  AS [残高]
FROM       ${DB_T_SRC}.[T_SF50030D_SRC001]  AS A
