...
# =========================================================================
# 追加テーブル名称  :                   | T_SN00800D_WK6
# フェーズ          :テーブル作成
# サイクル          :日次
# 実行日            :
# 参照テーブル      :                   | T_SN00800D_WK5
# 参照テーブル      :                   | T_SN00802D_WK1
#
# 備考              :ＦＧ証券用顧客口座情報作成
#
# 変更履歴
...
/*  13_統合ＣＩＦ内ＦＧ証券契約設定 */
/* ******************************************************/
INSERT INTO ${INFO_DB}.[T_SN00800D_WK6]
SELECT
    A.[作成基準日]                         AS [作成基準日],
...
FROM      ${INFO_DB}.[T_SN00800D_WK5]  A
LEFT JOIN ${INFO_DB}.[T_SN00802D_WK1]  B
