...
SELECT
  ...
  [HOSCFB]           AS [ＣＩＦ番号],
  CASE
   WHEN [Isa_Knjyo_Kbn] = '1' THEN '3310300000002'
   WHEN [Isa_Knjyo_Kbn] = '2' THEN '3310400000001'
   WHEN [Isa_Knjyo_Kbn] = '3' THEN '3310400000002'
   WHEN [Isa_Knjyo_Kbn] = '4' THEN '3310400000003'
   WHEN [Isa_Knjyo_Kbn] =  '' THEN
     CASE
     WHEN [J_Isa_Kbn] =  ''   THEN '3310300000001'
     WHEN [J_Isa_Kbn] <> ''   THEN '3310300000003'
     ELSE '' END
   ELSE '' END           AS [商品コード]
FROM (
   SELECT
