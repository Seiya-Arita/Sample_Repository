...
# =========================================================================
# 作成テーブル名称  :更新なし最小旧代表に変わった世帯	| T_NY07803D_WK11
# フェーズ          :テーブル作成
# サイクル          :日次
# 実行日            :
# 参照テーブル      :旧代表に変わった世帯		| T_NY07803D_WK9
#                   :更新なし最小旧代表抽出		| T_NY07804D_WK10
#    
# 変更履歴
# -------------------------------------------------------------------------
...
INSERT INTO ${INFO_DB}.[T_NY07803D_WK11]
SELECT
    A.[統合ＣＩＦ番号],
    A.[前日世帯番号],
    A.[前日世帯代表フラグ],
    ...
    CASE WHEN B.[最新世帯番号] IS NOT NULL
         ...
         ELSE A.[最新フラグ]
    END AS [最新フラグ]
FROM ${INFO_DB}.[T_NY07803D_WK9] AS A
LEFT JOIN ${INFO_DB}.[T_NY07804D_WK10] AS B
