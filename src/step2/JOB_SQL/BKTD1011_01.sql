...
# ==============================================================================
# 作成テーブル名称  :流動性基本断面展開                        | HN_INFO.T_KT10110D_OBJ
# フェーズ          :共通処理
# サイクル          :日次
# 参照テーブル      :預金ＣＩＦ基本S                           | HN_V_SRC.T_YK51010D_SRC001
...
/* 流動性基本断面展開 */
/* ****************************************************************** */
INSERT INTO ${INFO_DB}.T_KT10110D_OBJ
SELECT
    B.[基準日]
   ,A.[TBN]
   ,A.[CFB]
...
FROM
  (SELECT
     ...
     ,[CDLCOD]
     ,[SBTCOD]
     ,SUBSTRING([RDSSJW],4,1) AS [流動性商品情報]
     ,[KZTBEE]
     ,[SSSHYJ]
   FROM ${DB_T_SRC}.T_YK51010D_SRC001 WHERE [Record_Deleted_Flag] = 0
