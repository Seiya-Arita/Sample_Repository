...
# =========================================================================
# 作成テーブル名称  :証券保険残高			|	T_SN02410D_OBJ
# フェーズ          :目的別テーブル作成（連番付与）
# サイクル          :日次
# 実行日            :毎日（DAY365）
# 参照テーブル      :証券保険残高ロード			|	T_SN02410D_LOAD
#
# 備考              :
#
# 変更履歴
...
/*              目的別テーブルクリア                              */
/* ****************************************************************** */
DELETE FROM [${INFO_DB}].[T_SN02410D_OBJ];
SELECT @ErrorCode = @@ERROR;
IF @ErrorCode <> 0 GOTO ENDPT;
/* ****************************************************************** */
/*              目的別テーブル作成                                */
/* ****************************************************************** */
INSERT INTO [${INFO_DB}].[T_SN02410D_OBJ]
SELECT
