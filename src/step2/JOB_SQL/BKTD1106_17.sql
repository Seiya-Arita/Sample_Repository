...
# ==============================================================================
# 作成テーブル名称  :預金計数ワーク 科目25(定期積金)           | HN_INFO.T_KT11070D_WK17
# フェーズ          :ＣＩＦ残高
# サイクル          :日次
# 参照テーブル      :定期預積金基本展開                        | HN_INFO.T_KT10150D_OBJ
...
/* 預金計数ワーク 科目25(定期積金) */
/* ****************************************************************** */
INSERT INTO ${INFO_DB}.T_KT11070D_WK17
SELECT
     MAX([基準日])       AS [作成基準日]
    ,A.[店番]            AS [店番]
    ,A.[ＣＩＦ番号]      AS [ＣＩＦ番号]
    ,A.[科目]            AS [科目]
    ,'2020000000000'     AS [商品コード]
