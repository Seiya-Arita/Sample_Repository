...
# ==============================================================================
# 作成テーブル名称  :預かり資産残高＿九州ＦＧ投信              | HN_INFO.T_NY03002D_WK6
# フェーズ          :預かり資産残高
# サイクル          :日次
# 参照テーブル      :HDRZ証券投信残高明細                      | HN_V_SRC.T_SK51040D_SRC001
...
/* HDRZ証券投信残高明細 */
/* ****************************************************************** */
INSERT INTO ${INFO_DB}.[T_NY03002D_WK6]
SELECT
   B.[前日] AS [作成基準日],
   A.[HOSTBN] AS [店番],
   A.[HOSCFB] AS [ＣＩＦ番号],
   ...
   A.[JQAHYGGOK] AS [残高]
FROM ${DB_T_SRC}.[T_SK51040D_SRC001] AS A
