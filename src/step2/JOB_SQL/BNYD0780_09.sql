...
# =========================================================================
# 作成テーブル名称  :旧代表に変わった世帯		| T_NY07803D_WK9
# フェーズ          :テーブル作成
# サイクル          :日次
# 実行日            :
# 参照テーブル      :新代表に変わった世帯		| T_NY07803D_WK6
#                   :更新なし旧代表抽出２		| T_NY07804D_WK8
#    
# 変更履歴
# -------------------------------------------------------------------------
...
INSERT INTO ${INFO_DB}.T_NY07803D_WK9
SELECT
    A.[統合ＣＩＦ番号],
    A.[前日世帯番号],
    A.[前日世帯代表フラグ],
    ...
    CASE WHEN B.[最新世帯番号] IS NOT NULL
         ...
         ELSE A.[最新フラグ]
    END AS [最新フラグ]
FROM ${INFO_DB}.T_NY07803D_WK6 AS A
LEFT JOIN ${INFO_DB}.T_NY07804D_WK8 AS B
