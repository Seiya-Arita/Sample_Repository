...
# ==============================================================================
# 作成テーブル名称  :預金計数ワーク 科目13(通知預金)           | HN_INFO.T_KT11070D_WK03
# フェーズ          :ＣＩＦ残高
# サイクル          :日次
# 参照テーブル      :通知預金抽出                              | HN_INFO.T_KT10130D_OBJ
...
/* 預金計数ワーク 科目13(通知預金) */
/* ****************************************************************** */
INSERT INTO ${INFO_DB}.T_KT11070D_WK03
SELECT
     MAX([基準日])       AS [作成基準日]
    ,A.[店番]            AS [店番]
    ,A.[ＣＩＦ番号]      AS [ＣＩＦ番号]
    ,A.[科目]            AS [科目]
    ,'3010000000000'     AS [商品コード]
